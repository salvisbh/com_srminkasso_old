...
class SrmInkassoViewActivity extends JView
{
    ...
    protected $formId = 'activity-form';
	...
	protected function addToolbar()
	{
		...
		if ($this->item->id == 0) {
			JToolBarHelper::title(JText::_('Neue Leistung'));
		} else {
			JToolBarHelper::title(JText::_('Leistung mutieren'));
		}
