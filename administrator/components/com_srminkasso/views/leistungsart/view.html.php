...
class SrmInkassoViewLeistungsart extends JView
{
    ...
    protected $formId = 'leistungsart-form';
	...
	protected function addToolbar()
	{
		...
		if ($this->item->id == 0) {
			JToolBarHelper::title(JText::_('Neue Leistungsart'));
		} else {
			JToolBarHelper::title(JText::_('Leistungsart mutieren'));
		}

        /* Speichern */
		JToolBarHelper::apply('leistungsart.apply', 'JTOOLBAR_APPLY');

		/* Speichern und Schließen Controller mything */
		JToolBarHelper::save('leistungsart.save', 'JTOOLBAR_SAVE');

		/* Button speichern und neu. Kein spezielles Icon ausgewählt */
		JToolBarHelper::save2new('leistungsart.save2new');

		/* Button "als Kopie speichern". Kein spezielles Icon ausgewählt */
		JToolBarHelper::save2copy('leistungsart.save2copy');

		/* Button cancel; Controller mything */
		JToolBarHelper::cancel('leistungsart.cancel', 'JTOOLBAR_CANCEL');
	}
