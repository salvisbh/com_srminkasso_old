 ...
 */
class SrmInkassoModelLeistungsart extends JModelAdmin
{
  /**
   ...
   */
  public function getTable($type = 'Leistungsarts', $prefix = 'SrmInkassoTable', $config = array())
  {
  ...
  public function getForm($data = array(), $loadData = true)
  {
    ...
    $form    = $this->loadForm('srminkasso', 'leistungsart', $options);
    if (empty($form)) {
      return false;
    }
  ...
  protected function loadFormData()
  {
    ...
    $data = $app->getUserState('com_srminkasso.edit.leistungsart.data', array());
